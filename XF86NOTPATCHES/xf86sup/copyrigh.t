Copyright (c) 1995, 1996 by Holger Veit

This is the COPYRIGHT file for the complete xf86sup driver, containing the
following devices:
...
In the following, 'code' denotes the source and binary code contained
in the files contained in this directory and directories below, unless 
otherwise noted.
...
displayed at installation time of the driver remains intact, and the driver
code is not torn apart, i.e. by extraction of certain functions and building
a new driver with restricted functionality and claiming this as new own 
art work.

(* By using this code with GPL'd or LGPL'd code this driver does NOT 
inherit the GNU license rules - if this contradicts to GPL or LGPL, this
code must not be used with code under such special licensing regulations).

The files in the API directory and the example files in the EXAMPLE directory
are public domain and may be used or adapted without any restriction.
